...
Copy all assets (css, js, styles, uswds) into the 'assets' folder under the _site folder. This should be done automatically, but 11ty is buggy in this so a manual move is a quick easy fix.

9/6/23: Footer note: gsa-logo.svg was not displaying so I placed a png copy in the _site folder and it seems to have fixed it. 